...
class CoinSimpleListAdapter(
    var coins: List<Coin>,
    val clickListener: (Coin) -> Unit
) : RecyclerView.Adapter<CoinSimpleListAdapter.ViewHolder>(), MyCoinAdapter {
    ...
    override fun onBindViewHolder(holder: ViewHolder, pos: Int) =
        holder.bind(coins[pos], clickListener)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(coin: Coin, clickListener: (Coin) -> Unit) =
            with(itemView) {
